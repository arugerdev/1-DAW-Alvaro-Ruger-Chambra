...
public class Practica3_2_2 extends Ejercicio {

	public Practica3_2_2(String name, boolean finished) {
		super(name, finished);
	}
	...
	public void start(Stage stage) {
		...
		Text enun = new Text(String.format("3.2.2. Dibujar F"));
		enun.setFont(Font.font(12));
		disp.getChildren().add(enun);

		lineJump(disp);

		Text title = new Text(String.format("Dibujar F"));
