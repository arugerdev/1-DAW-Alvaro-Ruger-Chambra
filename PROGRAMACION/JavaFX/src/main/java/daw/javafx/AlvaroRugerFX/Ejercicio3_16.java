...
public class Ejercicio3_16 extends Ejercicio{

	public Ejercicio3_16(String name, boolean finished) {
		super(name, finished);
	}
	...
	public void start(Stage stage) {
		...
		Text enun = new Text(String.format("16. Escribe un programa que diga cuál es la última cifra de un número entero introducido por teclado."));
		enun.setFont(Font.font(12));
    	disp.getChildren().add(enun);

    	lineJump(disp);
    	
		Text title = new Text(String.format("Inserta el numero que quiere saber su ultima cifra: "));
    	...
    	submit.setOnAction(e -> {
    		...
    		disp.getChildren().add(new Label("La ultima cifra es " + Math.abs(n.getValue() % 10)));

    	});
		
		var scene = new Scene(disp, 480, 320);
        stage.setTitle("Ultima cifra");
