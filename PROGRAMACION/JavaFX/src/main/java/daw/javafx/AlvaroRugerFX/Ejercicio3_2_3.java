...
public class Ejercicio3_2_3 extends Ejercicio {

	public Ejercicio3_2_3(String name, boolean finished) {
		super(name, finished);
	}
	...
	public void start(Stage stage) {
		...
		Text enun = new Text(String.format(
				"3.2. 3. Escribe un programa que pinte una pirámide rellena con un carácter introducido por teclado que podrá ser una letra, \n"
						+ " un número o un símbolo como *, +, -, $, &, etc. El programa debe permitir al usuario mediante un menú elegir si el vértice \n"
		...
		Spinner<Integer> dir = new Spinner<>(0, 3, 0);
